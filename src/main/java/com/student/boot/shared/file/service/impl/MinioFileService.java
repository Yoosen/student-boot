package com.student.boot.shared.file.service.impl;
...
import com.student.boot.shared.file.service.FileService;
import com.student.boot.shared.file.model.FileInfo;
import io.minio.*;
...
public class MinioFileService implements FileService {
     ...
     *
     * @param filePath 文件路径
     *                 https://oss.student.tech/default/20221120/test.jpg
     * @return
     */
    @Override
    public boolean deleteFile(String filePath) {
        ...
        try {
            ...
            if (StrUtil.isNotBlank(customDomain)) {
                // https://oss.student.tech/default/20221120/test.jpg → 20221120/websocket.jpg
