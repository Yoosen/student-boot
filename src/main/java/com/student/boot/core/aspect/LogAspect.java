package com.student.boot.core.aspect;
...
import com.student.boot.common.util.IPUtils;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.student.boot.common.annotation.Log)")
    public void logPointcut() {
    }

    @Around("logPointcut() && @annotation(logAnnotation)")
    public Object logExecutionTime(ProceedingJoinPoint joinPoint, com.student.boot.common.annotation.Log logAnnotation) throws Throwable {
